...
class FrontyColorPage extends StatefulWidget {
  final Order order;

  FrontyColorPage({required this.order});

  @override
  _FrontyColorPageState createState() => _FrontyColorPageState();
}

class _FrontyColorPageState extends State<FrontyColorPage> {
  @override
